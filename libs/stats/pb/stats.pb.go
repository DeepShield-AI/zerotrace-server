...
type Stats struct {
	...
	OrgId                uint32    `protobuf:"varint,9,opt,name=org_id,json=orgId,proto3" json:"org_id,omitempty"`
...
var fileDescriptor_b4756a0aec8b9d44 = []byte{
	...
	,
}
...
func (m *Stats) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.TeamId != 0 {
		i = encodeVarintStats(dAtA, i, uint64(m.TeamId))
		i--
		dAtA[i] = 0x50
	}
	if m.OrgId != 0 {
		i = encodeVarintStats(dAtA, i, uint64(m.OrgId))
		i--
		dAtA[i] = 0x48
	}
...
func (m *Stats) Size() (n int) {
	...
	if m.OrgId != 0 {
		n += 1 + sovStats(uint64(m.OrgId))
	}
	if m.TeamId != 0 {
		n += 1 + sovStats(uint64(m.TeamId))
	}
	if m.XXX_unrecognized != nil {
